...
const ServiceCard = ({ service, index }) => (
  <motion.div
    ...
    className="group bg-[#E8E4DF] rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
  >
...
const ServicesPage = () => {
    ...
    < div className = "absolute inset-0 bg-gradient-to-r from-blue-600/30 to-blue-800/30" ></div >
      ...
      < div className = "absolute top-0 left-0 w-full h-full overflow-hidden" >
      {
        [...Array(15)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute rounded-full bg-[#E8E4DF]/5"
            initial={{
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/contact"
                className="bg-[#E8E4DF] text-blue-700 hover:bg-blue-50 font-semibold px-8 py-4 rounded-lg text-lg transition duration-300"
              >
                Get a Free Quote
              </Link>
              <Link
                to="/gallery"
                className="bg-transparent border-2 border-white hover:bg-[#E8E4DF] hover:bg-opacity-10 font-semibold px-8 py-4 rounded-lg text-lg transition duration-300"
              >
                View Our Work
              </Link>
            </div>
  ...
  < section className = "py-20 bg-gradient-to-r from-blue-50 to-indigo-50" >
    <div className="container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="bg-[#E8E4DF] p-8 rounded-xl shadow-lg text-center transform hover:scale-105 transition duration-300">
  ...
  {/* Service Categories */ }
  < div className = {`bg-[#E8E4DF] border-b sticky top-0 z-30 shadow-sm transition-all duration-300 ${isScrolled ? 'py-2' : 'py-0'}`}>
    <div className="container mx-auto px-6">
        ...
        <div className="flex space-x-1">
          {serviceCategories.map((category) => (
            <motion.button
              ...
              className={`px-5 py-3 font-medium text-sm md:text-base rounded-full mx-1 transition-all duration-300 ${activeTab === category.id
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {benefits.map((benefit, index) => (
            <motion.div
              key={index}
              className="relative bg-[#E8E4DF] p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-8">
            {technologies.slice(0, 2).map((tech, index) => (
              <motion.div
                key={index}
                className="bg-[#E8E4DF] p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-start"
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              key={index}
              className="relative bg-[#E8E4DF] p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center z-10"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: index * 0.2, duration: 0.5 }}
  ...
  < section className = "py-20 " >
    <div className="container mx-auto px-6">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-[#E8E4DF] rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8">
