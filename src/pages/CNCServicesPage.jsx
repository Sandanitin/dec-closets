      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Our CNC Services?</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Advanced CNC routers for superior accuracy</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center mr-3 mt-1">
                    <svg className="h-4 w-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Custom design support (CAD/CAM assistance)</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center mr-3 mt-1">
                    <svg className="h-4 w-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700">Affordable pricing for all project sizes</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center mr-3 mt-1">
                    <svg className="h-4 w-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">High-Precision Machining</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">3D Sculpting & Relief Carving</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Custom Shapes & Geometries</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Batch Production</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Fine Detailing</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Advanced Software</h3>
              <p className="text-gray-600">
                Specialized CAD/CAM software for translating artistic concepts into precise CNC toolpaths
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Plastics & Composites</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <svg className="h-5 w-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Metals & Engineering Plastics</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <svg className="h-5 w-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Decorative Panels</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Wooden Doors</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Signboards</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Artistic</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center">
              ...
              <p className="text-gray-600">
                Custom orders from single items to large-scale production
              </p>
            </div>
          </div>
        </div>
